...
import { getEnhancedMultimodalPrompt, type EnhancedMultimodalCapabilities, type MultimodalContext } from './enhanced-multimodal';
...
export const getSystemPrompt = (
  ...
  // Se capacidades multimodais estão habilitadas, usar o prompt avançado
  if (multimodalCapabilities && Object.keys(multimodalCapabilities).some(key => multimodalCapabilities[key as keyof EnhancedMultimodalCapabilities])) {
    return getEnhancedMultimodalPrompt(cwd, supabase, designScheme, multimodalCapabilities, multimodalContext);
  }
  
  // Caso contrário, usar o prompt padrão
  return `
