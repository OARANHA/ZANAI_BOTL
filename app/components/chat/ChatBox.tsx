  ...
  return (
    ...
    >
      ...
      >
        ...
        {props.multimodalCapabilities && Object.values(props.multimodalCapabilities).some(Boolean) && (
          <div className="absolute top-2 right-2 z-10">
            <div className="flex items-center gap-1 bg-purple-100 text-purple-800 px-2 py-1 rounded-full text-xs font-medium">
              ...
              {Object.values(props.multimodalCapabilities).filter(Boolean).length} multimodal
              {Object.values(props.multimodalCapabilities).filter(Boolean).length === 1 ? '' : 's'}
            </div>
          </div>
        )}
        <ClientOnly>
